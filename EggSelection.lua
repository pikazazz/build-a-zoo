...
local function getRarityColor(rarity)
    if rarity >= 100 then
        return Color3.fromRGB(255, 69, 58) -- Fire red
    elseif rarity >= 50 then
        return Color3.fromRGB(175, 82, 222) -- Electric purple
    elseif rarity >= 20 then
        return Color3.fromRGB(88, 86, 214) -- Diamond blue
    elseif rarity >= 10 then
        return Color3.fromRGB(255, 159, 10) -- Golden yellow
    elseif rarity >= 6 then
        return Color3.fromRGB(255, 45, 85) -- Ultra pink
    elseif rarity >= 5 then
        return Color3.fromRGB(255, 69, 58) -- Legendary red
    elseif rarity >= 4 then
        return Color3.fromRGB(175, 82, 222) -- Epic purple
    elseif rarity >= 3 then
        return Color3.fromRGB(88, 86, 214) -- Rare blue
    elseif rarity >= 2 then
        return Color3.fromRGB(48, 209, 88) -- Uncommon green
    else
        return Color3.fromRGB(174, 174, 178) -- Common gray
    end
end
